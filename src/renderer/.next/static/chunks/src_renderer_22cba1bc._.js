...
function WriterStatsPanel({ showRightSidebar, toggleRightSidebar, writerStats, setWordGoal, currentText = '', projectId }) {
            ...
            try {
                ...
                const response = await electron.invoke('ai:chat-completion', {
                    messages: [
                        ...
                        "WriterStatsPanel.useCallback[sendMessageToOpenAI]": (msg)=>({
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].error('AI_CHAT', 'Failed to get AI response', error);
                // 오류 메시지 추가
                const errorMessage = {
                    role: 'ai',
    ...
    const handleSendMessage = async ()=>{
        ...
        setIsAiTyping(true);
        try {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].info('WRITER_STATS', '실제 OpenAI API 호출', {
                message: userInput
            });
            // Loop OpenAI 서비스 호출
            ...
            if (!response.ok) {
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].error('WRITER_STATS', 'API 응답 에러', {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].info('WRITER_STATS', 'API 응답 성공', {
            ...
            const err = error;
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].error('WRITER_STATS', 'AI 채팅 에러', err);
            setMessages((prev)=>[
                    ...prev,
                    {
                        role: 'ai',
    ...
    const handleAIImproveText = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$3$2e$4_$40$babel$2b$core$40$7$2e$27$2e$7_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "WriterStatsPanel.useCallback[handleAIImproveText]": async ()=>{
            ...
            try {
                ...
                const data = await response.json();
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].info('WRITER_STATS', 'Text improvement completed', {
                    responseLength: data.response?.length || 0
                });
                setAiResults({
    ...
    const handleAICharacterAnalysis = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$3$2e$4_$40$babel$2b$core$40$7$2e$27$2e$7_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "WriterStatsPanel.useCallback[handleAICharacterAnalysis]": async ()=>{
            ...
            try {
                ...
                const data = await response.json();
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].info('WRITER_STATS', 'Character analysis completed', {
                    responseLength: data.response?.length || 0
                });
                setAiResults({
    ...
    const handleAIPlotCheck = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$3$2e$4_$40$babel$2b$core$40$7$2e$27$2e$7_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "WriterStatsPanel.useCallback[handleAIPlotCheck]": async ()=>{
            ...
            try {
                ...
                const data = await response.json();
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].info('WRITER_STATS', 'Plot analysis completed', {
                    responseLength: data.response?.length || 0
                });
                setAiResults({
    ...
    const handleAIDialogueImprovement = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$3$2e$4_$40$babel$2b$core$40$7$2e$27$2e$7_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "WriterStatsPanel.useCallback[handleAIDialogueImprovement]": async ()=>{
            ...
            try {
                ...
                const data = await response.json();
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].info('WRITER_STATS', 'Dialogue improvement completed', {
                    responseLength: data.response?.length || 0
                });
                setAiResults({
