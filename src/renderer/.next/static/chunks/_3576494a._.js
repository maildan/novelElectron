        ...
        "AiPage.useCallback[handleSendMessage]": async ()=>{
            ...
            setTimeout({
                "AiPage.useCallback[handleSendMessage]": ()=>{
                    ...
                    setIsTyping(false);
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Logger"].info('AI_PAGE', 'AI response sent', {
                        content: aiMessage.content
                    });
                }
            }["AiPage.useCallback[handleSendMessage]"], 1500);
        }
    }["AiPage.useCallback[handleSendMessage]"], [
        inputMessage
    ]);
...
_s(AiPage, "DIzboNrcOeMzgKtwrblNsNFvLq4=");
_c = AiPage;
var _c;
