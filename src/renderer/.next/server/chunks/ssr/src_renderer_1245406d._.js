...
(()=>{
    const e = new Error("Cannot find module './MarkdownUtils'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module './EditorConfig'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
'use client';
            ...
            handleKeyDown: (view, event)=>{
                ...
                if (event.key === ' ') {
                    ...
                    if (textBefore === '#') {
                        event.preventDefault();
                        event.stopPropagation();
                        // 🔥 QA 가이드: setTimeout 제거, 직접적인 체인 명령어 사용
                        const range = {
                            from: $from.pos - 1,
                            to: $from.pos
                        };
...
//# sourceMappingURL=src_renderer_1245406d._.js.map