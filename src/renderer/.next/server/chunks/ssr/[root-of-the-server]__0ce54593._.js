...
const SIDEBAR_ITEMS = [
    {
        id: 'dashboard',
        label: '대시보드',
        icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$home$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Home$3e$__["Home"],
        href: '/',
        ariaLabel: '대시보드로 이동'
    },
    {
...
function RootLayout({ children }) {
    ...
    const handleNavigate = (href)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Logger"].debug('LAYOUT', 'Navigating to', {
                href,
                currentPath: pathname
            });
            router.push(href);
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Logger"].error('LAYOUT', 'Navigation failed, falling back to window.location', {
                href,
                error
            });
