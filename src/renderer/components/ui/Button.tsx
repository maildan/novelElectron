...
const BUTTON_STYLES = {
  base: 'inline-flex items-center justify-center rounded font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400',
...
export const Button: React.FC<ButtonProps> = ({
  ...
  const handleClick = (e: React.MouseEvent<HTMLButtonElement>) => {
    if (disabled) return;
    Logger.info('Button', `클릭됨: ${variant}`);
    onClick?.(e);
  };
  ...
  const Comp = disabled ? Slot : "button"
