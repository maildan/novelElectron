...
import { ZERO_COST_FLEX_PATTERNS, ZERO_COST_ICON_SIZES, ZERO_COST_GRID_PATTERNS, ZERO_COST_TEXT_PATTERNS } from '../common/optimized-styles';
...
export function AIAnalytics({ logs, loading }: CommonComponentProps) {
  ...
  return (
    <div className="space-y-6 p-6">
      {/* AI 기능 카드 */}
      <div className={ZERO_COST_GRID_PATTERNS.cols1Md2}>
      ...
      <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
        <div className="bg-gradient-to-r from-purple-600 to-blue-600 p-4">
          <div className={ZERO_COST_FLEX_PATTERNS.gap3}>
            <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center">
              <Bot className={ZERO_COST_ICON_SIZES.md + ' text-white'} />
            </div>
        ...
        <div className="p-4 border-b border-gray-100">
          <h3 className={ZERO_COST_TEXT_PATTERNS.textSmMediumGray700 + ' mb-3'}>빠른 질문</h3>
