...
export class MenuManager {
  ...
  async initialize(): Promise<void> {
    ...
    log.info("Console", '[MenuManager] 메뉴 매니저 초기화 시작');
    ...
    try {
      ...
      log.info("Console", '[MenuManager] 메뉴 매니저 초기화 완료');
    } catch (error) {
      log.error("Console", '[MenuManager] 메뉴 매니저 초기화 실패:', error);
      throw error;
    }
  }
  ...
  private async openFile(): Promise<void> {
    ...
    try {
      ...
      log.error("Console", '[MenuManager] 파일 열기 오류:', error);
    }
  }
  ...
  async cleanup(): Promise<void> {
    log.info("Console", '[MenuManager] 메뉴 매니저 정리 시작');
    
    // 애플리케이션 메뉴 제거
    Menu.setApplicationMenu(null);
    
    this.isInitialized = false;
    log.info("Console", '[MenuManager] 메뉴 매니저 정리 완료');
  }
}
